...
time="--time 21600"   #max run time per job in seconds allowed before killing jobs
disk_usage=" --disk 6000000000 "   #in bytes (or 1 Gb default)
ram="--ram 1000000000 "
