...
time="--time 40000"   #max run time per job in seconds allowed before killing jobs
disk_usage=" --disk 8000000000 "   #in bytes (or 1 Gb default)
ram="--ram 2000000000 "
