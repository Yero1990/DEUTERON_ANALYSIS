...
shell_script=" --command file /u/group/E12-10-003/cyero/hallc_replay/DEUTERON_ANALYSIS/hcswif/my_command_list_h2.txt"  #created multiple jobs (as opposed to one giant job) for each simc file inside .txt
