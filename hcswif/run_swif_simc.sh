...
workflow_name="d2_SIM_systematics"
...
time="--time 86400"   #max run time per job in seconds allowed before killing jobs (at most 24 hours per job, as each is 5 million events)
disk_usage=" --disk 2000000000 "   #in bytes (or 1 Gb default). (1 Gb per job currently used.)
ram=" --ram 3000000000 "
