...
#shell_script=" --command file /u/group/E12-10-003/cyero/hallc_replay/DEUTERON_ANALYSIS/hcswif/my_command_list2.txt"  #created multiple jobs (as opposed to one giant job) for each simc file inside .txt
...
disk_usage=" --disk 1000000000 "   #in bytes (or 1 Gb default). (1 Gb per job currently used.)
ram=" --ram 2000000000 "
