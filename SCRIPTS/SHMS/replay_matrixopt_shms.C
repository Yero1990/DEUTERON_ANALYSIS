void replay_matrixopt_shms (Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/shms_replay_matrixopt_%d_%d.root";
 ...
 THcHodoEff* peff = new THcHodoEff("phodeff"," SHMS hodo efficiency","P.hod");
  ...
  // Define DEF-file
  analyzer->SetOdefFile("UTIL_COMM_ONEPASS/DEF-files/SHMS/matrixopt.def");
  // Define cuts file
  analyzer->SetCutFile("UTIL_COMM_ONEPASS/DEF-files/SHMS/pstackana_matrixopt_cuts.def");  // optional
  ...
  analyzer->PrintReport("UTIL_COMM_ONEPASS/TEMPLATES/SHMS/PRODUCTION/pstackana_production.template",
  			Form("REPORT_OUTPUT/SHMS/PRODUCTION/replay_shms_matrixopt_%d_%d.report", RunNumber, MaxEvent));  // optional
