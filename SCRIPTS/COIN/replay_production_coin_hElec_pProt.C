void replay_production_coin_hElec_pProt (Int_t RunNumber = 0, Int_t MaxEvent = 0,const char* ftype="scaler_test") {
  ...
  //All runs before 4361 did NOT have hDCREF_5 added in ROC3
  if(RunNumber < 4361)
    {
