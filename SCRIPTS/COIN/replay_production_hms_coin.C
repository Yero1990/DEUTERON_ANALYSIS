void replay_production_hms_coin (Int_t RunNumber=0, Int_t MaxEvent=0, const char* ftype="hod_calib") {
  ...
  const char* ROOTFileNamePattern = "ROOTfiles/hms_coin_replay_%s_%d_%d.root";
