...
for ib in range(len(i_b)):
    ...
    red_dataXsec_arr = np.array([get_sig_red('red_dataXsec', 80, 1)[ib], get_sig_red('red_dataXsec', 580, 1)[ib], get_sig_red('red_dataXsec', 580, 2)[ib], get_sig_red('red_dataXsec', 750, 1)[ib], get_sig_red('red_dataXsec', 750, 2)[ib], get_sig_red('red_dataXsec', 750, 3)[ib]])
    red_dataXsec_m = ma.masked_values(red_dataXsec_arr, -1.)  #maske invalid values (-1)
    
    #Define the weights (Use ONLY statistical)
    red_dataXsec_weights = np.array([1./get_sig_red('red_dataXsec_err', 80, 1)[ib]**2, 1./get_sig_red('red_dataXsec_err', 580, 1)[ib]**2, 1./get_sig_red('red_dataXsec_err', 580, 2)[ib]**2, 1./get_sig_red('red_dataXsec_err', 750, 1)[ib]**2, 1./get_sig_red('red_dataXsec_err', 750, 2)[ib]**2, 1./get_sig_red('red_dataXsec_err', 750, 3)[ib]**2])
    ...
    kin_syst_arr = np.array([get_kin_syst('sig_kin_tot', 80, 1)[ib], get_kin_syst('sig_kin_tot', 580, 1)[ib],  get_kin_syst('sig_kin_tot', 580, 2)[ib],  get_kin_syst('sig_kin_tot', 750, 1)[ib], get_kin_syst('sig_kin_tot', 750, 2)[ib], get_kin_syst('sig_kin_tot', 750, 3)[ib] ])
    ...
    red_pwiaXsec_arr = np.array([get_sig_red('red_pwiaXsec', 80, 1)[ib], get_sig_red('red_pwiaXsec', 580, 1)[ib], get_sig_red('red_pwiaXsec', 580, 2)[ib], get_sig_red('red_pwiaXsec', 750, 1)[ib], get_sig_red('red_pwiaXsec', 750, 2)[ib], get_sig_red('red_pwiaXsec', 750, 3)[ib]])
    red_pwiaXsec_arr_m = np.ma.masked_values(red_pwiaXsec_arr, -1.)
    red_pwiaXsec_avg = np.ma.average(red_pwiaXsec_arr_m)
   
    red_fsiXsec_arr = np.array([get_sig_red('red_fsiXsec', 80, 1)[ib], get_sig_red('red_fsiXsec', 580, 1)[ib], get_sig_red('red_fsiXsec', 580, 2)[ib], get_sig_red('red_fsiXsec', 750, 1)[ib], get_sig_red('red_fsiXsec', 750, 2)[ib], get_sig_red('red_fsiXsec', 750, 3)[ib]])
