...
#to combined the data. When combining data, ONLY used statistical weight.  To combine the systematic errors
...
#\\ yb = pm                                                                        
# current header line:  
#! i_b[i,0]/ i_x[i,1]/ i_y[i,2]/ xb[f,3]/ yb[f,4]/ red_dataXsec_80[f,5]/  red_dataXsec_err_80[f,6]/   red_dataXsec_580set1[f,7]/  red_dataXsec_err_580set1[f,8]/   red_dataXsec_580set2[f,9]/  red_dataXsec_err_580set2[f,10]/   red_dataXsec_750set1[f,11]/  red_dataXsec_err_750set1[f,12]/ red_dataXsec_750set2[f,13]/  red_dataXsec_err_750set2[f,14]/  red_dataXsec_750set3[f,15]/  red_dataXsec_err_750set3[f,16]/    red_dataXsec_580avg[f,17]/   red_dataXsec_580avg_err[f,18]/   red_dataXsec_750avg[f,19]/   red_dataXsec_750avg_err[f,20]/  red_dataXsec_avg[f,21]/   red_dataXsec_avg_err[f,22]/  red_dataXsec_avg_syst_err[f,23]/   red_dataXsec_avg_tot_err[f,24]/   red_pwiaXsec_80[f,25]/  red_pwiaXsec_580set1[f,26]/ red_pwiaXsec_580set2[f,27]/ red_pwiaXsec_750set1[f,28]/ red_pwiaXsec_750set2[f,29]/ red_pwiaXsec_750set3[f,30]/  red_pwiaXsec_580avg[f,31]/  red_pwiaXsec_750avg[f,32]/ red_fsiXsec_80[f,33]/  red_fsiXsec_580set1[f,34]/ red_fsiXsec_580set2[f,35]/ red_fsiXsec_750set1[f,36]/ red_fsiXsec_750set2[f,37]/ red_fsiXsec_750set3[f,38]/  red_fsiXsec_580avg[f,39]/  red_fsiXsec_750avg[f,40]/  red_pwiaXsec_avg[f,41]/ red_fsiXsec_avg[f,42]/
"""
fout.write(header)
...
red_dataXsec_syst_err_1 = B.get_data(f1, 'red_dataXsec_syst_err')  
red_dataXsec_tot_err_1 = B.get_data(f1, 'red_dataXsec_tot_err')  
...
red_dataXsec_syst_err_2 = B.get_data(f2, 'red_dataXsec_syst_err')  
red_dataXsec_tot_err_2 = B.get_data(f2, 'red_dataXsec_tot_err')  
...
red_dataXsec_syst_err_3 = B.get_data(f3, 'red_dataXsec_syst_err')  
red_dataXsec_tot_err_3 = B.get_data(f3, 'red_dataXsec_tot_err')  
...
red_dataXsec_syst_err_4 = B.get_data(f4, 'red_dataXsec_syst_err')  
red_dataXsec_tot_err_4 = B.get_data(f4, 'red_dataXsec_tot_err')  
...
red_dataXsec_syst_err_5 = B.get_data(f5, 'red_dataXsec_syst_err')  
red_dataXsec_tot_err_5 = B.get_data(f5, 'red_dataXsec_tot_err')  
...
red_dataXsec_syst_err_6 = B.get_data(f6, 'red_dataXsec_syst_err')    
red_dataXsec_tot_err_6 = B.get_data(f6, 'red_dataXsec_tot_err')    
...
for ib in range(len(i_b)):
    ...
    if(w2==0 and w3==0):
        ...
        red_dataXsec_avg_syst_err_580 = np.nan
        
    else:
        red_dataXsec_avg_580 = (x2*w2 + x3*w3) / (w2 + w3)
        red_dataXsec_avg_err_580 = 1 / np.sqrt(w2 + w3)
        #calculate average systematics
        temp_syst_arr = np.array([red_dataXsec_syst_err_2[ib], red_dataXsec_syst_err_3[ib]])  #array to hold syst. err per bin, for different sets
        red_dataXsec_avg_syst_err_580 = np.nanmean(temp_syst_arr)  #average non-NaN values
    ...
    if(w4==0 and w5==0 and w6==0):
        ...
        red_dataXsec_avg_syst_err_750 = np.nan
    else:
        red_dataXsec_avg_750 = (x4*w4 + x5*w5 + x6*w6) / (w4 + w5 + w6)
        red_dataXsec_avg_err_750 = 1 / np.sqrt(w4 + w5 + w6)
        #calculate average systematics
        temp_syst_arr = np.array([red_dataXsec_syst_err_4[ib], red_dataXsec_syst_err_5[ib], red_dataXsec_syst_err_6[ib]])  #array to hold syst. err per bin, for different sets
        red_dataXsec_avg_syst_err_750 = np.nanmean(temp_syst_arr)  #average non-NaN values
    ...
    if(x80==0 and x580==0 and x750==0):
        ...
        red_dataXsec_avg_syst_err = np.nan
    else:
        red_dataXsec_avg = (x80*w80 + x580*w580 + x750*w750) / (w80 + w580 + w750)
        red_dataXsec_avg_err = 1. / np.sqrt(w80 + w580 + w750)
        #calculate systematic average
        temp_syst_arr = np.array([red_dataXsec_syst_err_1[ib], red_dataXsec_avg_syst_err_580, red_dataXsec_avg_syst_err_750])  #array to hold syst. err per bin, for different sets
        red_dataXsec_avg_syst_err = np.nanmean(temp_syst_arr)  #average non-NaN values

        #Calculate Overall Error (Stats + Syst)
    ...
    l="%i %i %i %f  %f %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e %.12e\n" % (i_b[ib], i_x[ib], i_y[ib], xb[ib], yb[ib],red_dataXsec_1[ib], red_dataXsec_err_1[ib], red_dataXsec_2[ib], red_dataXsec_err_2[ib], red_dataXsec_3[ib], red_dataXsec_err_3[ib], red_dataXsec_4[ib], red_dataXsec_err_4[ib], red_dataXsec_5[ib], red_dataXsec_err_5[ib], red_dataXsec_6[ib], red_dataXsec_err_6[ib], red_dataXsec_avg_580, red_dataXsec_avg_err_580, red_dataXsec_avg_750, red_dataXsec_avg_err_750, red_dataXsec_avg, red_dataXsec_avg_err, red_dataXsec_avg_syst_err, red_dataXsec_avg_tot_err, red_pwiaXsec_1[ib], red_pwiaXsec_2[ib], red_pwiaXsec_3[ib], red_pwiaXsec_4[ib], red_pwiaXsec_5[ib], red_pwiaXsec_6[ib], red_pwiaXsec_580avg, red_pwiaXsec_750avg, red_fsiXsec_1[ib], red_fsiXsec_2[ib], red_fsiXsec_3[ib], red_fsiXsec_4[ib], red_fsiXsec_5[ib], red_fsiXsec_6[ib], red_fsiXsec_580avg, red_fsiXsec_750avg, red_pwiaXsec_avg, red_fsiXsec_avg )
    fout.write(l)
fout.close()
