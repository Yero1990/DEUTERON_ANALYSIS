void getYield()
{
  ...
  for (int irun = 0; irun <4; irun++){
    ...
    TString simc_filename =  Form("heep_simc_histos_%d_rad.root", run[irun]);                                                                                                                                                             
    TString data_filename = Form("heep_data_histos_%d_combined.root",run[irun]);     
