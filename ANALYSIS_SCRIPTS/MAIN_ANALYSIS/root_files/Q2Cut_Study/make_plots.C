void make_plots()
{
  ...
  //Open ROOT files;
  TFile *data1_file = new TFile("Q2_set1/deep_data_histos_3289.root");
  TFile *simc1_file = new TFile("Q2_set1/deep_simc_histos_3289.root");
  
  TFile *data2_file = new TFile("Q2_set2/deep_data_histos_3289.root");
  TFile *simc2_file = new TFile("Q2_set2/deep_simc_histos_3289.root");
  
  TFile *data3_file = new TFile("Q2_set3/deep_data_histos_3289.root");
  TFile *simc3_file = new TFile("Q2_set3/deep_simc_histos_3289.root");
