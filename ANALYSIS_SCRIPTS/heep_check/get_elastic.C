void get_elastic(TString target, Double_t Ebeam, Double_t theta_elec)
{
  ...
  //Define Momentum Acceptance Limits on HMS/SHMS
  Double_t pHMS_min, pHMS_max;
  Double_t pSHMS_min, pSHMS_max;

  Double_t HdeltaMIN = -8.;
  Double_t HdeltaMAX = 8.;
  Double_t PdeltaMIN = -10.;
  Double_t PdeltaMAX = 20.;
  ...
  pHMS_max = kf*(1. - HdeltaMIN/100. );
  pHMS_min = kf*(1. - HdeltaMAX/100. );
  pSHMS_max = kf*(1. - PdeltaMIN/100. ); 
  pSHMS_min = kf*(1. - PdeltaMAX/100. );
  ...
  cout << " \n";
  cout << "*************************" << endl;
  cout << " Momentum Acceptance Range: " << endl;
  cout << "HMS: (" << pHMS_min << "," << pHMS_max << ")" << endl; 
  cout << "SHMS: (" << pSHMS_min << "," << pSHMS_max << ")" << endl; 
  cout << "*************************" << endl;
  cout << " \n";
  cout << "*************************" << endl;
